...
#5g
sed -i '/ set wireless.default_radio0${devidx}.ssid=OpenWrt/a\set wireless.default_radio0${devidx}.ssid=Karune_5G' package/kernel/mac80211/files/lib/wifi/mac80211.sh
#2.4g
sed -i '/ set wireless.default_radio1${devidx}.ssid=OpenWrt/a\set wireless.default_radio1${devidx}.ssid=Karune' package/kernel/mac80211/files/lib/wifi/mac80211.sh

#wifi加密方式encryption=sae-mixed
#使用sed 在第四行后添加新字(wifi加密方式，没有是none,wifi密码key为miku5201314521)
#2.4g
sed -i '/set wireless.default_radio0${devidx}.encryption=sae-mixed/a\set wireless.default_radio0${devidx}.key=gds.miku5201314521' package/kernel/mac80211/files/lib/wifi/mac80211.sh
#5g
sed -i '/set wireless.default_radio1${devidx}.encryption=sae-mixed/a\set wireless.default_radio1${devidx}.key=miku5201314521' package/kernel/mac80211/files/lib/wifi/mac80211.sh